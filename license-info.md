...
Whenever you share the source code, you also have to include a verbatim copy of the AGPL. If you share a modified
verion of the source code, you have to include a prominent notice that it's been modified and the date on which
you first modified it. Additionally, you must include a prominent notice that the source code is licensed under
the AGPL.
